...
app.controller('Analytics', ['$scope', '$http', function ($scope,$http) {
	$scope.go = function() {
		...
		//iGV
 		if(programa == '1'){
 			options.filters = '&filters%5Bcreated_at%5Bfrom%5D%5D=' + start_date + '&filters%5Bcreated_at%5Bto%5D%5D=' + end_date + '&filters%5Bfor%5D=opportunities&filters%5Bprogrammes%5D%5B%5D=1&filters%5Bstatuses%5D%5B%5D=open&per_page=200&filters%5Bopportunity_committee%5D=1535&sort=status'
		}//iGE
		else if(programa == '2'){
			options.filters = '&filters%5Bcreated_at%5Bfrom%5D%5D=' + start_date + '&filters%5Bcreated_at%5Bto%5D%5D=' + end_date + '&filters%5Bfor%5D=opportunities&filters%5Bprogrammes%5D%5B%5D=5&filters%5Bstatuses%5D%5B%5D=open&per_page=200&filters%5Bopportunity_committee%5D=1535&sort=status'
		}else{
			options.filters = '&filters%5Bcreated_at%5Bfrom%5D%5D=' + start_date + '&filters%5Bcreated_at%5Bto%5D%5D=' + end_date + '&filters%5Bfor%5D=opportunities&filters%5Bprogrammes%5D%5B%5D=2&filters%5Bstatuses%5D%5B%5D=open&per_page=200&filters%5Bopportunity_committee%5D=1535&sort=status'
