			...
			for(var i = 0; i < last_page; i++ ){
				...
				responses.data.allOpportunityApplication.data.forEach((e)=>{
					...
					people_expa.push({
						...
						"personal_goal_setting": e.standards[0].matching_with_opportunity === null ? 'Not filled' : e.standards[0].matching_with_opportunity,
						"outgoing_preparation": e.standards[1].matching_with_opportunity === null ? 'Not filled' : e.standards[1].matching_with_opportunity,
						"expectation_setting": e.standards[2].matching_with_opportunity === null ? 'Not filled' : e.standards[2].matching_with_opportunity,
						"insurance": e.standards[3].matching_with_opportunity === null ? 'Not filled' : e.standards[3].matching_with_opportunity,
						"visa_and_work_permit": e.standards[4].matching_with_opportunity === null ? 'Not filled' : e.standards[4].matching_with_opportunity,
						"arrival_pickup": e.standards[5].matching_with_opportunity === null ? 'Not filled' : e.standards[5].matching_with_opportunity,
						"accomodation": e.standards[6].matching_with_opportunity === null ? 'Not filled' : e.standards[6].matching_with_opportunity,
						"incoming_preparation": e.standards[7].matching_with_opportunity === null ? 'Not filled' : e.standards[7].matching_with_opportunity,
						"first_day_of_work": e.standards[8].matching_with_opportunity === null ? 'Not filled' : e.standards[8].matching_with_opportunity,
						"alignment_spaces_with_opp_provider": e.standards[9].matching_with_opportunity === null ? 'Not filled' : e.standards[9].matching_with_opportunity,
						"job_description": e.standards[10].matching_with_opportunity === null ? 'Not filled' : e.standards[10].matching_with_opportunity,
						"working_hours": e.standards[11].matching_with_opportunity === null ? 'Not filled' : e.standards[11].matching_with_opportunity,
						"duration": e.standards[12].matching_with_opportunity === null ? 'Not filled' : e.standards[12].matching_with_opportunity,
						"opportunity_benefits": e.standards[13].matching_with_opportunity === null ? 'Not filled' : e.standards[13].matching_with_opportunity,
						"departure_support": e.standards[14].matching_with_opportunity === null ? 'Not filled' : e.standards[14].matching_with_opportunity,
						"debrief_with_aiesec": e.standards[15].matching_with_opportunity === null ? 'Not filled' : e.standards[15].matching_with_opportunity,
